...
- **JavaScript**: [`update.mjs`](../scripts/installer/update.mjs) - Repository update system with merge support
...
# Updates
npm run update               # Manual update from repository (includes smart merge)
