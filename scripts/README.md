...
**Description:** Contains Node.js scripts for initial setup and repository-based updates.
...
**Purpose:** Repository ZIP-based auto-updater  
**Usage:** `node scripts/installer/update.mjs`  
**Description:** Downloads and applies updates from the remote repository without Git. Preserves user configuration files (`accounts.jsonc`, `config.jsonc`, `sessions/`).
