    ...
    <div class="settings-wrap" id="view-settings">
      ...
      <div class="settings-section settings-section-core" id="settings-core-premium">
        ...
        <div class="toggle-grid">
          ...
          <div class="toggle-wrap"><div class="toggle-wrap-left"><div class="toggle-label">Capture dashboard pages<span class="beta-badge">Maintenance</span><span class="next-badge">Next only</span></div><div class="toggle-sub">Harvest full dashboard snapshots (HTML + data) into the Page/ folder for selector upkeep. Wipes &amp; refills Page/ at the start of each run.</div></div><label class="toggle"><input type="checkbox" id="tog-core-captureDashboardPages"><span class="toggle-slider"></span></label></div>
        </div>
      </div>
